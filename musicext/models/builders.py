...
def get_encodec_autoencoder(encoder_name: str, cfg: omegaconf.DictConfig):
    if encoder_name == "seanet":
        ...
        encoder = musicext.modules.SEANetEncoder(**encoder_kwargs)
        decoder = musicext.modules.SEANetDecoder(**decoder_kwargs)
...
def get_debug_compression_model(device="cpu", sample_rate: int = 32000):
    ...
    encoder = musicext.modules.SEANetEncoder(**seanet_kwargs)
    decoder = musicext.modules.SEANetDecoder(**seanet_kwargs)
